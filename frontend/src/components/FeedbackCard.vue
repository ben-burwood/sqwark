<template>
  <div
    class="rounded-lg border border-base-content/10 bg-base-200 p-4 hover:border-base-content/20 transition-colors"
  >
    ...
    <div class="flex flex-wrap items-center gap-1.5 mt-3">
      ...
      <span
        class="text-[11px] text-base-content/30 ml-auto flex items-center gap-2"
      >
        <svg
