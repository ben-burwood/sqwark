  ...
  <div class="space-y-4">
    <div class="rounded-lg border border-base-content/10 bg-base-200 p-4">
      <div class="flex flex-col sm:flex-row gap-3 items-start sm:items-center">
        ...
        <label
          class="flex items-center gap-1.5 text-xs text-base-content/50 cursor-pointer select-none whitespace-nowrap"
        >
          <input
            type="checkbox"
    ...
    <div class="px-2">
      ...
      <div
        ...
        class="text-center py-16 text-sm text-base-content/30"
      >
        No feedback found.
      </div>
...
watch([search, sort, selectedTags, showArchived], () => fetchFeedback(), {
  deep: true,
});
